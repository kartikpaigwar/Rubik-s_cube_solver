...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void solveOptimal(CubieCube cu,char* output)
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
{
//------------------------initialisation---------------------------------------
...
char space[2]=" ";
//I will have to store everything in the output string that i have passed as an argument 
if (r_depth==1)//maneuver complete
{
	...
	if (snPNew->corn6Pos==0 && snPNew->edge6Pos==0 && snPNew->edge4Pos==0)
	{
		...
		{
			strcat(output,mv[sn[b].move]);//I am not sure if this part will work or not 
			strcat(output,space);   //hope it works
		}
